...
[Last updated: Tue May 22 09:32:34 CEST 2018]

This directory contains an example for BCG_MIN, CAESAR, EVALUATOR,
SVL and XTL. It describes Dekker's mutual exclusion algorithm.
...
Files:
   ...
   dekker.lnt             algorithm description in LNT
   macros.mcl             common definitions for the MCL formulas
   LOTOS/dekker.lotos     algorithm description in LOTOS
