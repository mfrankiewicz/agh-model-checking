...
#
# Autor : 	   Artur Brauer
# Erstellzetraum : 23.03.93
#
# Diese Datei enthaelt die Aufbauroutinen fuer den Steuerblock der 
# Fertigungszellen-Simulation (deutsche Version)
#
####################################################################
...
label $bedfr.roboter.arm1.name -relief flat -text "ARM1" -background $color_rob_a1_neu
frame $bedfr.roboter.arm1.links -relief flat
button $bedfr.roboter.arm1.links.f1 -relief raised -borderwidth 1 -text "vor" \
...
button $bedfr.roboter.arm1.links.f3 -relief raised -borderwidth 1 -text "zurueck" \
...
label $bedfr.roboter.arm2.name -relief flat -text "ARM2" -background $color_rob_a2_neu
frame $bedfr.roboter.arm2.links -relief flat
button $bedfr.roboter.arm2.links.f1 -relief raised -borderwidth 1 -text "vor" \
...
button $bedfr.roboter.arm2.links.f3 -relief raised -borderwidth 1 -text "zurueck" \
...
label $bedfr.roboter.rob.name -relief flat -text "ROBOTER" 
button $bedfr.roboter.rob.f1 -relief raised -borderwidth 1 -text "links" -command "schreibe robot_left"
button $bedfr.roboter.rob.f2 -relief raised -borderwidth 1 -text "stop" \
	-command "schreibe robot_stop"
button $bedfr.roboter.rob.f3 -relief raised -borderwidth 1 -text "rechts" \
...
label $bedfr.band2.name -relief flat -text "BAND_O" -background $color_b2_rand_neu
label $bedfr.band2.leer -relief flat -text ""
button $bedfr.band2.f1 -relief raised -borderwidth 1 -text "los" \
...
pack append $bedfr.band2 $bedfr.band2.name {top fillx} \
	...
	$bedfr.band2.leer {top fillx} 

######
#Band1
######
frame $bedfr.band1 -relief raised -borderwidth 1 
label $bedfr.band1.name -relief flat -text "BAND_U" -background $color_b1_rand_neu
label $bedfr.band1.leer -relief flat -text ""
button $bedfr.band1.f1 -relief raised -borderwidth 1 -text "los" \
...
pack append $bedfr.band1 $bedfr.band1.name {top fillx} $bedfr.band1.f1 {top fillx}\
	 $bedfr.band1.f2 {top fillx} $bedfr.band1.leer {top fillx}

#######
#Presse
#######1z
frame $bedfr.press -relief raised -borderwidth 1
label $bedfr.press.name -relief flat -text "PRESSE" -background $color_press_neu
button $bedfr.press.f1 -relief raised -borderwidth 1 -text "pressen"\
				 -command "schreibe press_upward"
button $bedfr.press.f2 -relief raised -borderwidth 1 -text "stop" \
	-command "schreibe press_stop"
button $bedfr.press.f3 -relief raised -borderwidth 1 -text "oeffnen"\
...
label $bedfr.tisch.name -relief flat -text "TISCH" -background $color_tab_neu
frame $bedfr.tisch.links -relief flat 
button $bedfr.tisch.links.f1 -relief raised -borderwidth 1 -text "links" \
...
button $bedfr.tisch.links.f3 -relief raised -borderwidth 1 -text "rechts" \
	-command "schreibe table_right"
frame $bedfr.tisch.rechts -relief flat 
button $bedfr.tisch.rechts.f1 -relief raised -borderwidth 1 -text "hoch" \
...
button $bedfr.tisch.rechts.f3 -relief raised -borderwidth 1 -text "runter" \
...
label $bedfr.hhger.name -relief flat -text "HHGER"

frame $bedfr.hhger.mitte -relief flat
frame $bedfr.hhger.mitte.links -relief flat 
button $bedfr.hhger.mitte.links.f1 -relief raised -borderwidth 1 -text "hoch" \
...
button $bedfr.hhger.mitte.links.f3 -relief raised -borderwidth 1 -text "runter" \
	-command "schreibe crane_to_belt1"
frame $bedfr.hhger.mitte.rechts -relief flat 
button $bedfr.hhger.mitte.rechts.f1 -relief raised -borderwidth 1 -text "heben" \
...
button $bedfr.hhger.mitte.rechts.f3 -relief raised -borderwidth 1 -text "senken" \
...
button $bedfr.teile.add -relief raised -borderwidth 1 -text "    \n TEIL \n    " \
			-command "schreibe blank_add"

button $bedfr.teile.get -relief raised -borderwidth 1 -text "EINSAMMELN" \
...
button $bedfr.teile.stat -relief raised -borderwidth 1 -text "STATUS" \
			-command "schreibe get_status"

button $bedfr.teile.deco -relief raised -borderwidth 1 -text "REACT" \
			-command "schreibe react"

pack append $bedfr.teile $bedfr.teile.add {top fillx} $bedfr.teile.get {top} \
			 $bedfr.teile.demo {top fillx} \
			 $bedfr.teile.rest {top fillx} \
			 $bedfr.teile.stat {top fillx} \
			 $bedfr.teile.deco {top fillx} 
